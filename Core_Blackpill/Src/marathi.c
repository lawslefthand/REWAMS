...
int main() {
	...
	while (1) {
		...
		printf("संवेदक डेटा लॉग करत आहे\n");
		...
		if (water_detection() == 1)
			...
			printf("पाण्याची वाट पाहत\n");

		printf("प्रवाहाचा दर  %d लिटर प्रति मिनिट आहे    \n", flow);
		printf("टर्बाइन आर. पी. एम. आहे %d\n", turbine_rot);
		printf("खंड आहे %d\n", vol);
		printf("तापमान %f\n", temp);
		printf("दबाव %f\n", press);
		printf("उंची. %f\n", alt);
		...
		if (t >= 1) {
			...
			if (is_welford_anomaly(&flow_stats, flow_roc_2, 1.5))
				printf("चेतावणीः प्रवाहाच्या दरात धोकादायक विसंगती! \n");
			if (is_welford_anomaly(&temp_stats, temp_roc_2, 1.5))
				printf("चेतावणीः तापमानात धोकादायक विसंगती!\n");
			if (is_welford_anomaly(&press_stats, press_roc_2, 1.5))
				printf("चेतावणीः दबावात धोकादायक विसंगती!       \n");
